...
add_maths_textbook_outlines(
    input=Path("spec.pdf"),
    output=Path("out.pdf"),
    answers_output=Path("answers.pdf"),
    introduction=8,
    acknowledgments=9,
    overview=10,
    glossary=696,
    chapters=[
        ...
        C(
            ...
            EC(
                ...
                [
                    ...
                    E(
                        186,
                        "Basic operations on complex numbers in modulus-argument form",
                        190,
                    ),
        ...
        C(
            604,
            EC(
                "Linear combinations of random variables and distribution of sample means",
                [
    ...
    answers=[
        ...
        CA(716, [EA(716, "A", "B"), EA(717, "C"), EA(718, "D", "F"), EA(719, R)]),
        CA(720, [EA(720, "A"), EA(722, "B", "C"), EA(723, "D"), EA(724, R)]),
        CA(
            727,
            [
                EA(727, "A", "D"),
        ...
        CA(
            752,
            [EA(752, "A"), EA(753, "B"), EA(755, "C"), EA(756, "D", "E"), EA(757, R)],
        ),
        CA(
            759,
            [
        ...
        CA(764, [EA(764, "A"), EA(765, "B", "C"), EA(766, "D", R)]),
        CA(769, R),
        CA(772, [EA(772, "A"), EA(773, "B"), EA(775, "C"), EA(776, "D"), EA(777, R)]),
        CA(778, [EA(778, "A", "B"), EA(779, "C", "E"), EA(780, "F", R)]),
        CA(781, R),
        CA(783, [EA(783, "A", "F"), EA(784, R)]),
        CA(784, [EA(784, "A", "B"), EA(785, "C", R)]),
        CA(786, R),
        CA(787, R),
    ],
)
